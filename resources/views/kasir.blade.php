...
<style>
    ...
    /* Style untuk produk habis stok (Monokrom) */
    .product-card.out-of-stock {
        filter: grayscale(100%); /* Ubah nilai grayscale menjadi 100% untuk monokrom */
        opacity: 0.7;
    }

    .product-card.out-of-stock .product-price {
        color: #666 !important; /* Ubah warna harga menjadi abu-abu */
    }
